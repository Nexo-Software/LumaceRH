...
from .views import EstadoIncidenciaUpdateView, IncidenciasGeneralListView, IncidenciasSucursalListView, IncidenciaUpdateView, EstadoIncdenciasGeneralUpdateView, IncidencasEmpleadoView
urlpatterns = [
